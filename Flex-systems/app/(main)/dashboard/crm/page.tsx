        ...
        <ModuleGuard module="CRM">
            <div className="p-8 max-w-7xl mx-auto">
                <Suspense fallback={<div className="h-20 animate-pulse bg-muted rounded-xl mb-8" />}>
                    <ModuleHeader
                        title="Customers (CRM)"
                        description="Manage your customer relationships and contact database"
                    />
                </Suspense>
                ...
                <div className="mt-8 p-12 border-2 border-dashed border-border rounded-2xl bg-muted/20 flex flex-col items-center justify-center text-center">
                    ...
                    <h2 className="text-2xl font-bold mb-3 text-foreground">CRM Module Under Construction</h2>
                    <p className="max-w-md text-muted-foreground text-lg">
                        Track leads, manage customer interactions, and grow your business with our CRM tools.
                    </p>
                    <div className="mt-8 flex gap-4">
                        <div className="px-4 py-2 bg-background rounded-lg border border-border text-sm font-medium">Contacts</div>
                        <div className="px-4 py-2 bg-background rounded-lg border border-border text-sm font-medium">Deals</div>
                        <div className="px-4 py-2 bg-background rounded-lg border border-border text-sm font-medium">Activities</div>
                    </div>
                </div>
            </div>
        </ModuleGuard>
